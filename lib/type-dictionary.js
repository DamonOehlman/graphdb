...
function GraphType(name, attributes) {
	...
	if (typeof attributes == 'object') {
		...
		this.NodePrototype = extendGraphNode(this.attributes);
	}
}
...
function extendGraphNode(attributes) {
	...
	_.each(attributes, function(value, key) {
		...
		Object.defineProperty(CustomGraphNode.prototype, key, {
			get: function() {
